...
EXPORT void     FASTCALL triangulofillgrp( PUNTOS a[], uint32_t colorA, uint32_t colorB, uint32_t colorC ); /* DIBUJA UN TRIANGULO RELLENO GRADIENTE CON SUS COORDENADAS ESPECIFICADAS CON LA STRUCTURA PUNTOS. Y EL COLOR VA DESDE EL COLOR A, LUEGO YEGAR AL COLOR B, LUEGO YEGAR AL COLOR C Y VOLVER AL COLOR DE A, SE LO LLAMA GRADIENTE DE COLOR */
...
EXPORT void     FASTCALL lineap( PUNTOS a[], uint32_t color ); /* DIBUJA UNA LINEA CON SUS COORDENADAS ESPECIFICADAS. Y COLOR USANDO RGB O RGBA */
...
EXPORT void     FASTCALL triangulop( PUNTOS a[], uint32_t color ); /* DIBUJA UN TRIANGULO CON SUS COORDENADAS ESPECIFICAS. Y COLOR USANDO RGB O RGBA */
EXPORT void     FASTCALL triangulofillp( PUNTOS a[], uint32_t color ); /* DIBUJA UN TRIANGULO RELLENO CON SUS COORDENADAS ESPECIFICAS. Y COLOR USANDO RGB O RGBA */
EXPORT void     FASTCALL lineagrp( PUNTOS a[], uint32_t colorA, uint32_t colorB ); /* DIBUJA UNA LINEA GRADIENTE CON SUS COORDENADAS ESPECIFICADAS. Y EL COLOR VA DESDE EL COLOR A, ASTA YEGAR AL COLOR B. SE LO LLAMA GRADIENTE DE COLOR */
EXPORT void     FASTCALL triangulogrp( PUNTOS a[], uint32_t colorA, uint32_t colorB, uint32_t colorC ); /* DIBUJA UN TRIANGULO GRADIENTE CON SUS COORDENADAS ESPECIFICADAS. Y EL COLOR VA DESDE EL COLOR A, LUEGO YEGAR AL COLOR B, LUEGO YEGAR AL COLOR C Y VOLVER AL COLOR DE A, SE LO LLAMA GRADIENTE DE COLOR */
...
EXPORT void     FASTCALL lineanormp( PUNTOS a[], uint32_t color ); /* DIBUJA UNA LINEA NORMALIZADA POR VECTORES CON SUS COORDENADAS ESPECIFICADAS. Y COLOR USANDO RGB O RGBA */
EXPORT void     FASTCALL linearcp( PUNTOS a[], uint32_t color ); /* DIBUJA UNA LINEA MEDIANTE RECORTE CON SUS COORDENADAS ESPECIFICADAS. Y COLOR USANDO RGB O RGBA */
